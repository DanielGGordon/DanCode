...
[done 2026-03-23 09:15] Full visual test suite passes. ⚠️ Learning: phi3.5 (3.7 GiB) cannot coexist with Chromium + test servers on Pi 5 (~2.5 GiB free). All Midscene aiAssert visual tests must use programmatic DOM/CSS/pixel verification instead. Also tmux window names are lowercase ("cli" not "CLI") — use case-insensitive comparisons.
